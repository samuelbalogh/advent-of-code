    ...
    with open(path, 'r') as data:
        ...
        while True:
            try:
                ...
                break
    result =''.join([sorted(profile[index], key=profile[index].get, reverse=True)[0] for index in profile])
    print(result)
    return  result
    ...
    with open(path, 'r') as data:
        ...
        while True:
            try:
                ...
                break
    result =''.join([sorted(profile[index], key=profile[index].get)[0] for index in profile])
    print(result)
    return  result
